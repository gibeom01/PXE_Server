...
# 2. 전면 iLO(톱니모양 - 관리 전용) 포트 연결

- Gen10 경우 USB 타입으로 MAC 연결 후 접속.

- 전면 포트 연결 시: 대역은 169.254.1.2/25 (Mac IP: 169.254.0.10/25)

#### * 전면 포트 없는 구형 모델의 경우 -> BIOS(System Setup) 진입해 수동으로 대역 설정 (가장 확실함) *
