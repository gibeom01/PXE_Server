# !!!!!!!!!!!!!!!!! 무조건 VM안에서 실행(오타 확인 후 진행.) !!!!!!!!!!!!!!!!!

# VM에서 powershell 관리자 권한 실행
...
New-NetFirewallRule -DisplayName $RuleName -Direction Inbound -LocalPort $CustomPort -Protocol TCP -Action AAllow | Out-Null
